...
<table width="80%" border="0" cellpadding="1" cellspacing="3">
  <tr class="txmainnew1">
    <td colspan="6" class="txmainnew1">Member:<%=mrow.get(1)%></td>
  </tr>
  <tr class="txmainnew1">
  ...
  <% 	
   datas =  FORMS.GetPersonalTask((String)mrow.get(0));
   if(datas.size()>0){
  ...
  <tr class="txmainnew1">
    <td colspan="6" class="block"><div align="center">No events yet.</div></td>
  </tr>
  <%}%>
</table>
<hr>
